...
import 'package:food_riders/mainScreens/parcel_delivering_screen.dart';
...
{
  late double sellerLat, sellerLng;
  ...
  getSellerData() async
  {
    ...
    {
         sellerLat = DocumentSnapshot["lat"];
         sellerLng = DocumentSnapshot["lng"];
    });
  }
