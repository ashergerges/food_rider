...
import 'package:food_riders/maps/map_utils.dart';
import 'package:food_riders/splashScreen/splash_screen.dart';
...
class _ParcelDeliveringScreenState extends State<ParcelDeliveringScreen>
{
  ...
  getOrderTotalAmount()
  {
    FirebaseFirestore.instance
        ...
        .then((snap)
    {
      orderTotalAmount = snap["totalAmount"].toString();
      widget.sellerId = snap["sellerUID"].toString();
    }).then((value)
    {
      getSellerData();
    });
  ...
  getSellerData()
  {
    FirebaseFirestore.instance
        ...
        .get().then((snap)
    {
      previousEarnings = snap["earnings"].toString();
    });
  }
